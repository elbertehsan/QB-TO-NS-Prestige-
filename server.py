...
#             # Hardcoded chunks — each is a (from_date, to_date) tuple

#         cls.unprocessed_date_chunks.add((datetime(2026, 4, 24).date(), datetime(2026, 4, 24).date()))
#         cls.unprocessed_date_chunks.add((datetime(2026, 4, 29).date(), datetime(2026, 4, 29).date()))
#         cls.unprocessed_date_chunks.add((datetime(2026, 4, 30).date(), datetime(2026, 4, 30).date()))
